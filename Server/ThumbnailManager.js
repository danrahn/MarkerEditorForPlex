...
class ThumbnailManager {
    ...
    */
     ...
     * @param {ConsoleLog.ConsoleLog} log The main application's logging instance.
    ...
    constructor(db, log, metadataPath) {
         ...
         * @type {Object<number, EpisodeCache>}
         */
        this.cache = {};
    }
...
class EpisodeCache {
    ...
    constructor(hasThumbs, bifPath='') {
        /** @type {boolean} Whether this episode has thumbnails available */
        this.hasThumbs = hasThumbs;

        /** @type {string} The path to `index-sd.bif`, if `hasThumbs` is `true` */
        this.bifPath = bifPath;

        /** @type {Object.<number, CachedThumbnail>} The cache of current thumbnails. */
        this.cachedThumbnails = {};

        /** @type {number} The number of seconds between thumbnails in `index-sd.bif` */
        this.interval = 0;
    }
}
